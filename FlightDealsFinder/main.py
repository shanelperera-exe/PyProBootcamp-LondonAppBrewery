...
for destination in sheet_data:
    ...
    if cheapest_flight.price == "N/A":
        ...
        print(f"Cheapest indirect flight price is: LKR {cheapest_flight.price}")
...
# ==================== Send Notifications and Emails  ====================
    ...
    if cheapest_flight.price != "N/A" and cheapest_flight.price < destination["lowestPrice"]:
        ...
        if cheapest_flight.stops == 0:
            message = f"Low price alert! Only LKR {cheapest_flight.price} to fly direct " \
                      f"from {cheapest_flight.origin_airport} to {cheapest_flight.destination_airport}, " \
                      f"on {cheapest_flight.out_date} until {cheapest_flight.return_date}."
        else:
            message = f"Low price alert! Only LKR {cheapest_flight.price} to fly " \
                      f"from {cheapest_flight.origin_airport} to {cheapest_flight.destination_airport}, " \
